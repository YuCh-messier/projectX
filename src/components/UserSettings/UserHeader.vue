    ...
    <div class="rounded bg-white" style="padding-bottom:11%;">
        ...
        <div class="relative lg:translate-x-4">
            <div class="absolute w-full z-30 space-x-6 translate-y-[-70%] lg:translate-y-[-50%]">
                ...
                <div id="headimg" class="border-4 shadow-xl w-1/6 h-0 bg-gray-200 rounded z-30 align-middle mx-auto hidden lg:inline-block" :style="'padding-top:16.6%;background-size: cover;'+'background-image:url('+standardinfo.headImg+');'"></div>
